...
$apartment_list_five = new \Elementor\Repeater();

$apartment_list_five->add_control(
    'title',
    [
...
treck_elementor_heading_option($apartment_list_five, 'Apartment Title', 'h3', 'layout_five');
...
$this->add_control(
    'layout_five_apartment_list',
    [
        'label' => __('Apartment Lists', 'treck-addon'),
        'type' => \Elementor\Controls_Manager::REPEATER,
        'fields' => $apartment_list_five->get_controls(),
        'prevent_empty' => false,
        'title_field' => '{{{ title }}}',
    ]
);
