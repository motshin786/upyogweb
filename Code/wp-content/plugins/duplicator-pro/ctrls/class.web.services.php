    ...
    public static function admin_notice_to_dismiss_callback()
    {
        ...
        switch ($noticeToDismiss) {
            ...
            case AdminNotices::FAILED_SCHEDULE_NOTICE:
                ...
                $ret                           = $systemGlobal->save();
                break;
            case LicenseNotices::CLOSE_TO_EXPIRE_DISMISS:
                $ret = ExpireOptions::set(LicenseNotices::CLOSE_TO_EXPIRE_DISMISS, true, LicenseNotices::CLOSE_TO_EXPIRE_DISMISS_DAYS);
                break;
            default:
