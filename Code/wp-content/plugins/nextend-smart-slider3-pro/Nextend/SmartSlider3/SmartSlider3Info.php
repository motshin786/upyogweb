...
class SmartSlider3Info {
    ...
    public static $version = '3.5.1.20';

    public static $channel = 'stable';

    public static $revision = '02dfae25e6c7f2d56918d6170e2f8de404662e45';

    public static $revisionShort = '02dfae25';

    public static $branch = 'release-3.5.1.20';
