...
// Disable Naming/Formating conventions for third party.
...
class Browser {
	...
	public function envira_debug_browser( $useragent = '' ) {
		$this->reset();
		if ( '' !== $useragent ) {
	...
	public function __toString() {
		...
		$ua_line_1 = substr( $text1, 0, 32 ); // the first line we print should only be the first 32 characters of the UA string
