		...
		<tr>
			<td height="25" style="background:#222;padding:15px 5%;font-size:1px;border-collapse:collapse;margin:0">
				<p style="margin-top:0;margin-bottom:0">
					<span style="color:#fff;font-size:20px;font-family:inherit;font-weight:bold;text-transform:uppercase;text-decoration:initial;line-height:40px;letter-spacing:normal"><?php echo $frequency; ?> Dark Mode Usage Report:</span>
				</p></td>
		</tr>
		...
		<tr>
			<td valign="top"
				...
				<div>
					...
					<p dir="ltr" style="margin-top:0;margin-bottom:0;margin-left:0;margin-right:0">
						Hello <?php echo $user_name; ?>,</p><br>
					<p dir="ltr"
					   style="margin-top:0;margin-bottom:0;margin-left:0;margin-right:0"><?php esc_html_e( 'Here is the dark mode usage report of last', 'wp-dark-mode-ultimate' ); ?> <?php echo $length; ?>
						days.</p>
					<p dir="ltr"
