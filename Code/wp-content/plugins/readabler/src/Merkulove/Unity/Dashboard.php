...
final class Dashboard {
		...
		if ( 'dashboard' === $screen->base ) {
			...
			wp_localize_script(
				...
				[
                    ...
                    'translation' => array(
                        'licenseActive'     => esc_html__( 'Licensed', 'readabler' ),
                        'licenseInactive'   => esc_html__( 'No license', 'readabler' ),
                        'licenseUnknown'    => esc_html__( 'No licence data', 'readabler' ),
                        'wait'              => esc_html__( 'Wait', 'readabler' ),
                    )
				]
			);
	...
	public function unity_dashboard_setup() {
		...
		wp_add_dashboard_widget(
			...
			esc_html__( 'Plugins Manager', 'readabler' ),
	...
	private function header_markup( ): string {
		...
		return wp_sprintf(
            ...
            esc_html__( 'Explore more plugins', 'readabler' ),
			esc_html__( 'opens in a new window', 'readabler' )
		);
    ...
    private function plugin_status_markup( $slug, $plugin ): string {
        ...
        $license_status = wp_sprintf(
	        ...
	        esc_html__( 'Plugin licence status', 'readabler' )
        );
        ...
        $update_status = wp_sprintf(
	        ...
	        esc_html__( 'Update to', 'readabler' ),
	        esc_html__( 'Latest', 'readabler' ),
