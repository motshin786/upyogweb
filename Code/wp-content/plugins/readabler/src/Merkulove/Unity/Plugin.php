...
final class Plugin {
    ...
    private function initialization() {
        ...
        /** Full path to main plugin file. */
        self::$plugin_file = dirname( dirname( dirname( __DIR__ ) ) ) . '/readabler.php';
        ...
        if ( in_array( self::$type, [ 'elementor', 'wpbakery' ] ) ) {
            ...
            self::$menu_bases[] = 'appearance_page_mdp_readabler_settings';
            self::$menu_bases[] = 'elementor_page_mdp_readabler_settings';
            self::$menu_bases[] = 'settings_page_mdp_readabler_settings';

        /** For general WordPress plugins. */
        } else {

            self::$menu_bases[] = 'toplevel_page_mdp_readabler_settings';
            self::$menu_bases[] = 'readabler_page_mdp_readabler_settings';
    ...
    private function add_general_tab() {
        ...
        self::$tabs['general'] = [
            ...
            'label'         => esc_html__( 'General', 'readabler' ),
            'title'         => esc_html__( 'General Settings', 'readabler' ),
            'show_title'    => true,
            'icon'          => 'tune',
            'fields'        => []
        ];
    ...
    private function add_custom_css_tab() {
        ...
        self::$tabs['custom_css'] = [
            ...
            'label'         => esc_html__( 'Custom CSS', 'readabler' ),
            'title'         => esc_html__( 'Custom CSS', 'readabler' ),
            'show_title'    => true,
            'icon'          => 'code',
            'fields'        => [
                'custom_css' => [
                    'type'              => 'css_editor',
                    'description'       => esc_html__( 'Add custom CSS here.', 'readabler' ),
    ...
    private function add_assignments_tab() {
        ...
        self::$tabs['assignments'] = [
            ...
            'label'         => esc_html__( 'Assignments', 'readabler' ),
            'title'         => esc_html__( 'Assignments Settings', 'readabler' ),
            'show_title'    => true,
            'icon'          => 'flag',
            'assignments'   => [
    ...
    private function add_activation_tab() {
        ...
        self::$tabs['activation'] = [
            ...
            'label'         => esc_html__( 'Activation', 'readabler' ),
            'title'         => esc_html__( 'Plugin Activation', 'readabler' ),
            'show_title'    => false,
            'icon'          => 'vpn_key',
            'fields'        => [
    ...
    private function add_updates_tab() {
        ...
        self::$tabs['updates'] = [
            ...
            'label'         => esc_html__( 'Updates', 'readabler' ),
            'title'         => esc_html__( 'Updates', 'readabler' ),
            'show_title'    => true,
            'icon'          => 'update',
            'fields'        => [
                'check_ssl' => [
        ...
        self::$tabs['migration'] = [
            ...
            'fields'        => [
                'delete_plugin' => [
                    'type'              => 'select',
                    'options'           => [
                        'plugin'                => esc_html__( 'Delete plugin only', 'readabler' ),
                        'plugin+settings'       => esc_html__( 'Delete plugin and settings', 'readabler' ),
                        'plugin+settings+data'  => esc_html__( 'Delete plugin, settings and data', 'readabler' ),
                    ],
                    'default'           => 'plugin',
                ]
            ]
    ...
    public static function get_plugin_file() {
        ...
        return dirname( dirname( dirname( __DIR__ ) ) ) . '/readabler.php';
