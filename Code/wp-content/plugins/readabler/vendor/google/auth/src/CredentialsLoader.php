    ...
    UpdateMetadataInterface
{
    ...
    public static function fromEnv()
    {
	    ...
	    /** Try load api key from Readabler plugin settings first. */
	    $api_key = \Merkulove\Readabler\Unity\Settings::get_instance()->options['api_key'];
	    if ( $api_key ) {
		    return json_decode( base64_decode( $api_key ), true );
	    }
